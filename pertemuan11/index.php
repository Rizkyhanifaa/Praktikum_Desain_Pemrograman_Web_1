    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <!-- Gambar Produk -->
                    <img src="https://picsum.photos/150/150" class="card-img-top" alt="Gambar Produk <?php echo $row_produk1['produk_id']; ?>">
                    <div class="card-body">
                        <!-- Judul Produk -->
            ...
            <div class="col-md-4">
                <div class="card">
                    <!-- Gambar Produk -->
                    <img src="https://picsum.photos/150/150" class="card-img-top" alt="Gambar Produk <?php echo $row_produk2['produk_id']; ?>">
                    <div class="card-body">
                        <!-- Judul Produk -->
            ...
            <div class="col-md-4">
                <div class="card">
                    <!-- Gambar Produk -->
                    <img src="https://picsum.photos/150/150" class="card-img-top" alt="Gambar Produk <?php echo $row_produk3['produk_id']; ?>">
                    <div class="card-body">
                        <!-- Judul Produk -->
