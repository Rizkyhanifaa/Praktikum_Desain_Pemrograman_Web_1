...
produk.user_id = user.user_id";
                            ...
                            ?>
                                ...
                                <div class="modal fade" id="editDataModal<?=
                                                                            $data['produk_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="editDataModalLabel" aria-hidden="true">
                                            ...
                                            <form method="POST" action="produk/ubah.php">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="number" class="form-control" id="number" name="stok" value="<?= $data['stok'] ?>">
                                                    </div>
                                                </div>
